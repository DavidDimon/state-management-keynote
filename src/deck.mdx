...
Muitos dos componentes podem possuir estados, e na maioria das vezes esses estados podem precisar ser reaproveitados, é ai que entra o state management
...
O props drilling é causado quando você passa props com a mesma instância pra diversos componentes, assim fazendo uma reação em cadeia na hora que esse estado atualizar, assim causando diversos re-renders desnecessários
